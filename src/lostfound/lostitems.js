		...
		if (this.state.Matches.length !== 0) {
			...
			return this.state.Matches.map((project) => (
				<div class="card-body">
					...
					{project.url && <img className="card-img-right" src={project.url} alt="lost" />}
			...
			<div className="col-sm-9 col-lg-6 m-auto lostfound">
				<div className="card card-body mt-4 mb-4 ">
					<div className="btn-group">
						<Button variant="btn top-buttons shadow-none py-1 px-3 disabled activated" onClick={() => history.push("/LostItems")}>
							all lost items
						</Button>
