		...
		if (e.target.files[0]) {
			...
			if (Math.round(file.size / 1024) >= 5120) {
				...
				var uploadTask = firebase
					.storage()
					.ref()
					.child('alumni/' + timeStamp + file.name)
					.put(file);
			...
			<div className='AlumniForm'>
				<Container text style={{ marginTop: '1em' }}>
					...
					<Form onSubmit={this.onSubmit}>
						...
						<strong>Dont click on Submit button untill all the uploaded images are visible on the screen, if clicked all the images may not be displayed!</strong>
						<br />
						<strong>Please, keep the image size strictly less than 5Mb.</strong>
