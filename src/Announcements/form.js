...
export class AnnounceForm extends Component {
  ...
  onSubmit = (e) => {
    e.preventDefault();
    const { title, password, message, from, show, deleteid } = this.state;
    const announce = {
      title,
      password,
      message,
      ...
      return this.state.Matches.map((project) => (
        <div>
          <div class="card-body announce">
            <button
              onClick={this.handleShow.bind(this, this.state.id[a++])}
              className="close"
              data-toggle="modal"
              data-target="#myModal"
              aria-label="close"
                ...
                <div className="form-check ">
                  <fieldset>
                    ...
                    <div className="form-group">
                      <button
                        type="submit"
                        className="btn btn-primary announce_submit"
                      >
                        Submit
                      </button>
                    </div>
