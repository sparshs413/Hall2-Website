  ...
  render(){
    return(
      ...
      {/* <Container className="gallery"> */}
        ...
        <h2 className='heading'><span>Our</span> Moments</h2>
        <div className="swiper-container">
            <div className="swiper-wrapper">
                <div className="swiper-slide" >
                  <img className='img_center' src={require('../Home/images/hall2.jpg')} />
                  <div className='text'>
                    galxy
                  </div>
                </div>
                <div className="swiper-slide" >
                  <img className='img_center' src={require('../Home/images/tv.jpg')} />
                  <div className='text'>
                    galxy
                  </div>
                </div>
                <div className="swiper-slide" >
                  <img className='img_center' src={require('../Home/images/hall2_6.jpg')} />
                  <div className='text'>
                    galxy
                  </div>
                </div>
