...
import {Container, Label, Button, Icon, Input, Dropdown } from 'semantic-ui-react';
...
class FormExtras extends Component {
  constructor(props) {
    ...
    this.state = { 
      smShow: false,
      is_mess_admin: true,
      extras: [{sunday:{'zxaa':{price:30, available: 4},'c':{price:30, available: 4}}, monday:{'zxaa':{price:30, available: 4},'c':{price:30, available: 4}}},
