		...
		return (
			<div className='tv' id='tv'>
				<div class='sidebar_facilities'>
					...
					<a href='/canteen' style={{ backgroundColor: 'rgb(8, 200, 47)', fontWeight: 'bold', color: '#fff' }}>
						Canteen
					</a>
				...
				<Container className='tv_cont' text>
					...
					<div className='para'>
						This is the place to get all the food stuff other than mess. Canteen timings are from 2 pm to 2 am. It attracts most of the hall junta for evening snacks and popular late night
						munchings. A plethora of varieties are available to cater to your taste buds. Additional facilities like LCD tv are also available to draw the crowd, especially on match days.
					</div>
